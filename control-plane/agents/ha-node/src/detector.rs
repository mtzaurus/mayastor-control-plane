...
impl NvmeController {
    /// Instantinate Nvme controller for given NQN and system path.
...
impl PathFailureDetector {
    ...
    /// Instantinate Nvme cache front-end.
...
impl NvmePathCache {
    pub async fn lookup_controller(&self, nqn: String) -> anyhow::Result<NvmeController> {
